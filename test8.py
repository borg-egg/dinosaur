...
walkers = []
img_game_over= pygame.image.load('test3.png').convert_alpha()
...
while True: # the main game loop
	...
	if intro_running == True:
		# blit intro
		#intro_running = Fal
		DISPLAYSURF.blit(img_intro, (50,0))
		pygame.display.flip ()
		...
		textSurfaceObj = fontObj.render('Gelaufene Meter:  ' + str(int(switch)) , True, GREEN)
